...
app.all('*', (req, res) => {
    res.status(404).send("Resources not found on Dolphin")
})

// this is the connection url for the database
const connectionUrl = 'mongodb+srv://wyILipYzqpcb2abiCt75:wyILipYzqpcb2abiCt75@cluster0.4vehq.mongodb.net/myFirstDatabase?retryWrites=true&w=majority'
